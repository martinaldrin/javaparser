...
public class PatternVariableIntroductionTest {
    ...
    /**
     * Tests for Switch Patterns with Unnamed Patterns (Java 22 JEP456)
     * Tests the Language Processing Pipeline's handling of unnamed patterns and variables 
     * in switch expressions and statements
     * 
     * @see <a href="https://openjdk.org/jeps/456">JEP 456: Unnamed Variables & Patterns</a>
     */
    @Nested
    class SwitchPatternsWithUnnamedPatterns {
        
        @Test
        public void switchPatternWithUnnamedPattern() {
            CompilationUnit cu = parse("class Test {\n"
                    + "    public String test(Object o) {\n"
                    + "        return switch (o) {\n"
                    + "            case String color -> color;\n"
                    + "            default -> \"No color\";\n"
                    + "        };\n"
                    + "    }\n"
                    + "}");
        ...
        @Test
        public void switchPatternWithUnnamedPatternNestedRecords() {
            CompilationUnit cu = parse("class Test {\n"
                    + "    public String test(Object o) {\n"
                    + "        return switch (o) {\n"
                    + "            case String content -> content;\n"
                    + "            case Integer info -> info.toString();\n"
                    + "            default -> \"No info\";\n"
                    + "        };\n"
                    + "    }\n"
                    + "}");
        ...
        @Test
        public void switchPatternWithUnnamedPatternInBlock() {
            CompilationUnit cu = parse("class Test {\n"
                    + "    public void test(Object o) {\n"
                    + "        switch (o) {\n"
                    + "            case String name -> {\n"
        ...
        @Test
        public void switchPatternWithUnnamedPatternShouldNotResolveInDifferentCase() {
            CompilationUnit cu = parse("class Test {\n"
                    + "    public String test(Object o) {\n"
                    + "        return switch (o) {\n"
            ...
            NameExpr name = Navigator.findNameExpression(cu, "name").get();
            assertEquals("java.lang.String", name.resolve().getType().describe());
            
            NameExpr value = Navigator.findNameExpression(cu, "value").get();
            assertEquals("java.lang.Integer", value.resolve().getType().describe());
        }

        @Test
        public void switchStatementWithUnnamedPatternTraditionalSyntax() {
            CompilationUnit cu = parse("class Test {\n"
                    + "    public void test(Object o) {\n"
                    + "        switch (o) {\n"
                    + "            case String name:\n"
        ...
        @Test
        public void switchPatternWithUnnamedPatternPrimitiveTypes() {
            CompilationUnit cu = parse("class Test {\n"
                    + "    public String test(Object o) {\n"
                    + "        return switch (o) {\n"
                    + "            case Integer speed when speed > 100 -> \"Fast\";\n"
                    + "            case Integer speed -> \"Slow\";\n"
            ...
            cu.findAll(NameExpr.class).stream()
                    .filter(nameExpr -> nameExpr.getNameAsString().equals("speed"))
                    .forEach(nameExpr -> {
                        assertEquals("java.lang.Integer", nameExpr.resolve().getType().describe());
                    });
        }

        @Test
        public void switchPatternWithUnnamedPatternInstanceofIntegration() {
            CompilationUnit cu = parse("class Test {\n"
                    + "    public String test(Object o) {\n"
                    + "        if (o instanceof String color) {\n"
                    + "            return switch (o) {\n"
                    + "                case String name -> name + \" \" + color;\n"
                    + "                default -> \"Unknown\";\n"
                    + "            };\n"
                    + "        }\n"
                    + "        return \"Not a string\";\n"
            ...
            // The color from instanceof should be in scope for the return expression
            cu.findAll(NameExpr.class).stream()
            ...
            // The name from switch should be in scope within its case
            cu.findAll(NameExpr.class).stream()
